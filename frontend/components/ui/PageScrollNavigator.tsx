...
export function PageScrollNavigator() {
  ...
  return (
    <div
      className={cn(
        "hidden lg:flex fixed left-8 top-1/2 -translate-y-1/2 z-50 flex-col gap-4 group transition-all duration-300",
        isScrolling ? "opacity-100 translate-x-0 pointer-events-auto" : "opacity-0 -translate-x-4 pointer-events-none"
      )}
    >
