      ...
      <div className="container-site py-16 md:py-20">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {serviceLinks.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} prefetch={true} className="text-sm text-primary-200 hover:text-white transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
              <li className="pt-2">
                <Link href="/services" prefetch={true} className="text-sm font-bold text-accent hover:text-white transition-colors">
                  ...Click for more
                </Link>
              </li>
            </ul>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-primary-200">
                ...
                <span>Lapaz, Accra<br />Ghana</span>
              </li>
              ...
              <li className="flex items-center gap-3 text-sm text-primary-200">
                ...
                <a href="tel:+233558213055" className="hover:text-white transition-colors">+233 558 213 055</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-400/30 mt-16 pt-8 flex flex-col items-center gap-6">
          ...
          <p className="text-primary-300 text-sm text-center">
            © {new Date().getFullYear()} Energy Insight GH. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
